...
## ✍️ Descrição
Exemplificação da sintaxe basica usando JAVASCRIPT
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-js.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/gOZrrjV) 
